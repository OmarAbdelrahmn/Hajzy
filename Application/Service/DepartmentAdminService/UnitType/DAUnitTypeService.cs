...
{
    public class DAUnitTypeService :IDAUnitTypeService
    {
        private readonly ApplicationDbcontext _context;
        private readonly ILogger<UnitTypeService> _logger;
        private readonly ICurrentDpartmentAdmin _currentDpartmentAdmin;

        public DAUnitTypeService(
            ApplicationDbcontext context,
            ILogger<UnitTypeService> logger,
            ICurrentDpartmentAdmin currentDpartmentAdmin
            )
        {
            _context = context;
            _logger = logger;
            _currentDpartmentAdmin = currentDpartmentAdmin;
        }
