...
public interface IDepartmanetService
{
    ...
    Task<Result<IEnumerable<DepartmentResponse>>> GetAllAsync(bool includeInactive = false);
    ...
    Task<Result<IEnumerable<DepartmentResponse>>> GetByCountryAsync(string country);
