...
namespace Hajzzy.Controllers.DepartmentAdminControllers
{
    [Route("api/department-admin/[controller]")]
    [ApiController]
    [Authorize(Roles = "DepartmentAdmin")]
    public class ReviewController(IDAReviewService reviewService) : ControllerBase
    {
        private readonly IDAReviewService _reviewService = reviewService;
        ...
        [Authorize(Roles = "UnitAdmin,DepartmentAdmin")]
        ...
        [Authorize(Roles = "DepartmentAdmin,Moderator")]
