...
namespace Domain.Migrations
{
    ...
    [Migration("20260306170356_addingthepackages")]
    partial class addingthepackages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 6, 17, 3, 55, 49, DateTimeKind.Utc).AddTicks(9335),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEE2Qtjk/iQ1Y1zVSYg4JcSNfD9jMJYhu5SNHsp/Q5ox06oM4iPomlWohTA9gyFKWgA==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "B4555410-F5B0-45B1-B963-1B2351A0723C",
                            CreatedAt = new DateTime(2026, 3, 6, 17, 3, 55, 112, DateTimeKind.Utc).AddTicks(6244),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKdWQN1Fds0Fdsk9dzxPKij/0TzOTXXs8b8FCbf1n4yX4zgJdqJrAv0j8Ogchd3N3A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9FABB58491024B7BB140E4D6658B5BDA",
                            TwoFactorEnabled = false,
                            UserName = "CityAdmin"
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 6, 17, 3, 55, 170, DateTimeKind.Utc).AddTicks(1576),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBOHJEia8Cw5LfB0QFx9EStG5iVfJnyIzFKq8PYSuN5w1ztXnFtWd/xA9/8nYZBv2g==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("Domain.Entities.NewsletterCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FilterCityId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("FilterFromDate")
                        .HasColumnType("datetime2");

                    b.Property<bool?>("FilterRegisteredUsersOnly")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("FilterToDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("FilterUnitId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.NewsletterSendLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.SubUnitOptionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SubUnitTypeOptionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubUnitTypeOptionId");

                    b.ToTable("SubUnitOptionValues");
                });

            modelBuilder.Entity("Domain.Entities.SubUnitTypeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubUnitTypeOptions");
                });

            modelBuilder.Entity("Domain.Entities.SubUnitTypeOptionSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubUnitTypeOptionSelections");
                });
            ...
            modelBuilder.Entity("Domain.Entities.SubUnitTypee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Description = "Deluxe hotel room with extra amenities",
                            IsActive = true,
                            Name = "DeluxeRoom"
                        },
                        new
                        {
                            Id = 3,
                            Description = "Spacious hotel suite",
                            IsActive = true,
                            Name = "Suite"
                        },
                        new
                        {
                            Id = 4,
                            Description = "Executive-level suite",
                            IsActive = true,
                            Name = "ExecutiveSuite"
                        },
                        new
                        ...
                        {
                            Id = 7,
                            Description = "Small vacation cottage",
                            IsActive = true,
                            Name = "Cottage"
                        },
                        new
                        {
                            Id = 8,
                            Description = "Single-story bungalow",
                            IsActive = true,
                            Name = "Bungalow"
                        },
                        new
                        {
                            Id = 9,
                            Description = "Wooden or nature cabin",
                            IsActive = true,
                            Name = "Cabin"
                        },
                        new
                        ...
                        {
                            Id = 13,
                            Description = "Luxury glamping tent",
                            IsActive = true,
                            Name = "GlamingTent"
                        },
                        new
                        ...
                        {
                            Id = 15,
                            Description = "Event or banquet hall",
                            IsActive = true,
                            Name = "Hall"
                        },
                        new
                        {
                            Id = 16,
                            Description = "Mountain or resort chalet",
                            IsActive = true,
                            Name = "Chalet"
                        },
                        new
                        {
                            Id = 17,
                            Description = "Bed in shared dormitory",
                            IsActive = true,
                            Name = "DormBed"
                        },
                        new
                        {
                            Id = 18,
                            Description = "Private room in shared property",
                            IsActive = true,
                            Name = "PrivateRoom"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UnitCustomPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.UnitOptionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnitTypeOptionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UnitTypeOptionId");

                    b.ToTable("UnitOptionValues");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UnitTypeOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnitTypeOptions");
                });

            modelBuilder.Entity("Domain.Entities.UnitTypeOptionSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.others.PaymentMethodd", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Booking", b =>
                {
                    b.HasOne("Domain.Entities.Package", "SelectedPackage")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.NewsletterSendLog", b =>
                {
                    b.HasOne("Domain.Entities.NewsletterCampaign", "Campaign")
                        .WithMany("SendLogs")
            ...
            modelBuilder.Entity("Domain.Entities.SubUnitOptionValue", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.SubUnitTypeOption", "SubUnitTypeOption")
                        .WithMany("SubUnitValues")
                        .HasForeignKey("SubUnitTypeOptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SubUnit");

                    b.Navigation("SubUnitTypeOption");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Unit", b =>
                {
                    b.HasOne("Domain.Entities.CancellationPolicy", null)
                        .WithMany("Units")
                        .HasForeignKey("CancellationPolicyId");
            ...
            modelBuilder.Entity("Domain.Entities.UnitOptionValue", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.UnitTypeOption", "UnitTypeOption")
                        .WithMany("UnitValues")
                        .HasForeignKey("UnitTypeOptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
