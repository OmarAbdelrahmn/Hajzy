...
namespace Domain.Migrations
{
    ...
    [Migration("20260223195333_addingoptionstounitsandsubunits")]
    partial class addingoptionstounitsandsubunits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 23, 19, 53, 31, 298, DateTimeKind.Utc).AddTicks(7530),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEC05xDNuAwrmsftVjHvEhwShJklVmjdQPIt0j5IyOswmnbvFg/W/KuL1M0xoeeXBhg==",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "B4555410-F5B0-45B1-B963-1B2351A0723C",
                            CreatedAt = new DateTime(2026, 2, 23, 19, 53, 31, 391, DateTimeKind.Utc).AddTicks(7883),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEF+j3BB08QIAzLVviyo/9g48jHte+yLvAtwReJMLjyuMqksTdw5yLeFvBWzGyccR0g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9FABB58491024B7BB140E4D6658B5BDA",
                            TwoFactorEnabled = false,
                            UserName = "CityAdmin"
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 23, 19, 53, 31, 497, DateTimeKind.Utc).AddTicks(8238),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEC9WI0PFeG0vjis7I5ylc13Lg4BRFCCUB/JhJpk3k231Onje48l4UY3MWRnb/g8ygw==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("Domain.Entities.SubUnitOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubUnitOptions");
                });

            modelBuilder.Entity("Domain.Entities.SubUnitOptionSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SubUnitOptionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubUnitOptionId");

                    b.ToTable("SubUnitOptionSelections");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UnitOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.UnitOptionSelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UnitOptionSelections");
                });
            ...
            modelBuilder.Entity("Domain.Entities.SubUnitOptionSelection", b =>
                {
                    b.HasOne("Domain.Entities.SubUnitOption", "SubUnitOption")
                        .WithMany("Selections")
                        .HasForeignKey("SubUnitOptionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SubUnitOption");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UnitOptionSelection", b =>
                {
                    b.HasOne("Domain.Entities.UnitOption", "UnitOption")
                        .WithMany("Selections")
